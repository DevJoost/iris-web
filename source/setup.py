...
setup(
    ...
    packages=['app', 'app.models', 'app.blueprints', 'app.blueprints.case', 'app.blueprints.login',
              'app.blueprints.manage', 'app.blueprints.search',
              'app.blueprints.context', 'app.blueprints.profile', 'app.blueprints.reports',
              'app.blueprints.dashboard', 'app.iris_engine',
              'app.iris_engine.utils', 'app.iris_engine.tasker',
              'app.iris_engine.reporter',
              'app.flask_dropzone'],
